...
function ProductList() {
    ...
    ); // Get the total quantity of items in the cart from Redux state
    ...
    const handleAddToCart = (plant) => {
        ...
        // Update the addedToCart state to reflect the addition
                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            ...
                            <span className="cart-quantity">{cartQuantity}</span> {/* Display the total quantity in the cart */}
                        </a>
                    </div>
                </div>
            </div>
